...
module Inspector
  ...
  #
  class CommandProcessor < Byebug::Processor
    attr_reader :display
    ...
    def at_line(context, file, line)
      Byebug.source_reload if Byebug::Setting[:autoreload]
    ...
    def one_unknown_cmd(commands, input)
      unless Byebug::Setting[:autoeval]
    ...
    #
    def postloop
      Byebug::Setting[:autosave] ? @interface.history.save : @interface.history.clear
    end
...
module Kernel
  def inspector
    interface = Inspector::Interface.new
